...
import tv.com.androidtvcodelab.apiservice.APIService

/**
 * Loads a grid of cards with movies to browse.
 */
class MainFragment : BrowseFragment() {
    private val mApiService: APIService = APIService.create()
    ...
    private fun loadRows(movieList :List<Movie>) {
        val list = movieList
    ...
    private inner class ItemViewSelectedListener : OnItemViewSelectedListener {
        override fun onItemSelected(itemViewHolder: Presenter.ViewHolder?, item: Any?,
            ...
            if (item is Movie) {
                mBackgroundUri = "http://image.tmdb.org/t/p/w1280/"+item.backdrop_path //diubah
